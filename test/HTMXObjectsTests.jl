...
using Test, Random, HTMXObjects, HTTP, Tables
...
function test_auto_html_rendering()
...
function test_htmx_request_headers()
...
function test_hx_response_headers()
...
function test_htmx_struct_property_access()
...
function test_indexed_all_default_indices()
...
function test_htmx_full_page_template()
...
function test_recording_end_to_end()
...
function test_queryparam_helper()
...
function test_static_transform()
...
function test_post_route_verb_metadata()
...
function test_type_conversion_indexed_routes()
...
function test_hx_response_location()
...
function test_queryparams_multi_value()
...
function test_queryparam_multi_value()
...
function test_nothing_default_kwargs_route()
...
function test_markdown_response()
...
function test_sortable_table_js()
...
function test_convert_param_vectors()
...
function test_fmt_time()
    @testset "fmt_time" begin
        @test fmt_time(1.5e-9) == "1.5ns"
        @test fmt_time(4.56e-6) == "4.56μs"
        @test fmt_time(0.0789) == "78.9ms"
        @test fmt_time(1.23) == "1.23s"
