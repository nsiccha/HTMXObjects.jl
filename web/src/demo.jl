...
@htmx struct DemoRoutes
    @get index() = h.div(
        ...
        h.section(
            h.h2("Slow load (3s)"),
            h.button(hx_get=__self__/"slow_load", hx_target="#slow-result", hx_swap="outerHTML")("Load something slow"),
            h.div(id="slow-result")(),
        ),
        h.section(
            h.h2("Instant success"),
            h.button(hx_get=__self__/"instant_ok", hx_target="#instant-result", hx_swap="innerHTML")("Instant OK"),
            h.div(id="instant-result")(),
        ),
        h.section(
            h.h2("Server error"),
            h.button(hx_get=__self__/"will_fail", hx_target="#error-result", hx_swap="innerHTML")("Trigger error"),
